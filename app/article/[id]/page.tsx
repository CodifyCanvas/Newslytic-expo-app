...
const ArticlePage = () => {
  ...
  const ArticleBody = useMemo(() => {
    ...
    return (
      <View className="bg-light rounded-t-3xl px-4 pt-6 pb-10 -mt-10 z-20">
  ...
  <View style={{ flex: 1 }}>
    ...
    <ScrollView className="flex-1 relative">
      {/* Header icons */}
      <View className="absolute mt-auto px-5 w-full flex flex-row justify-between top-4 z-30">
        <TouchableOpacity
          className="bg-white/20 backdrop-blur-lg isolate p-3 rounded-full"
          onPress={router.back}
        >
